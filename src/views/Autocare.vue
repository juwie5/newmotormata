  ...
  <div>
    <section>
      ...
      <section id="hero-video">
        <video loop muted autoplay preload="auto">
          ...
          Your browser does not support the video tag. Use Chrome, Safari or Firefox. Get updated.
        </video>

        <div class="hero-vid-caption">
          <h1 class="hero-vid-title">Auto Care Products & Parts</h1>
          <p class="hero-vid-paragraph">Auto Care Products & Parts | Tyres | Battery | Replacement Parts</p>
        </div>
      </section>
      <section id="maintenance-container">
    <div class="mc-whiteBox">
      <h1 class="mc-title">Auto Care Products & Parts</h1>
      <hr class="service-divider">
      <div class="row services-box">

        <div class="col-lg-6 mc-period-services">
          <span>Auto Care products</span>
    ...
    <div class="service-container">
      <div class="basic-service">
        ...
        <p class="bs-title">Basic Service</p>
