    ...
    <section>
      ...
      <section id="hero-video">
        ...
        <div class="hero-vid-caption">
          <h1 class="hero-vid-title">Insurance & Documents</h1>
          <p class="hero-vid-paragraph">Insurance | Registration | Renewal | Ownership Transfer</p>
        </div>
      </section>
      <section id="maintenance-container">
    <div class="mc-whiteBox">
      <h1 class="mc-title">Insurance & Documents</h1>
